...
class BookingFile extends FileUploadModel {
    ...
    public function rules() {
        ...
        return array(
            array('uid, booking_id, file_ext', 'required'),
    ...
    public function initAppModel($appFile) {
        $this->setBookingId($appFile['bookingId']);
        $userId = null;
        if (isset($appFile['userId'])) {
    ...
    public function getAllByBookingIdAndUserId($bookingId, $userId) {
        return $this->getAllByAttributes(array('booking_id' => $bookingId, 'user_id' => $userId));
    }
