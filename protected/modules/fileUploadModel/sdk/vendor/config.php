...
class Config {
    ...
    public static function getBucketByTableName($tableName) {
        $buckets = array('user_doctor_cert' => 'doctor-cert', 'booking_file' => 'medical-record', 'patient_mr_file' => 'medical-record');
        return $buckets[$tableName];
    }

    //根据空间名获取空间链接
    public static function getDomainByBucket($bucket) {
        $domains = array('medical-record' => 'http://7xq93p.com2.z0.glb.qiniucdn.com', 'doctor-cert' => 'http://7xq939.com2.z0.glb.qiniucdn.com');
